from PyQt5.QtWidgets import QDialog, QVBoxLayout, QRadioButton, QSizePolicy
...
class Show_msg(QDialog):
    ...
    def createAndStyleRadioButton(self, title):
        ...
        radioButton.setSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)  # 너비와 높이를 고정된 크기로 설정
        # radioButton.setMinimumSize(10, 10) 
        # radioButton.setMaximumSize(10, 10) 
